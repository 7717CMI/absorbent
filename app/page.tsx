    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="container mx-auto px-6 py-6 flex-1">
          ...
          <div className="flex-1 flex justify-center">
            <div className="text-center">
              ...
              <h2 className="text-sm text-black">
                {dashboardName || 'Global Super Absorbent Polymers SAP Market'}
              </h2>
            </div>
          </div>
        ...
        <div className="mb-6 flex items-start gap-3 rounded-lg border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-800">
          ...
          <p><span className="font-semibold">NOTE:</span> All the data in this dashboard is demo data. No real-world data is related to this.</p>
        </div>
